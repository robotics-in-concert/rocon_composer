...
ServiceStore.prototype._generate = function(package, service_meta, package_name, workflow_items){
      ...
      return that.github.checkout(new_branch_name).then(function(){
        ...
        .then(function(packages){ 
          ...
          .then(function(workflow_items){
            ...
            return that._generate(pack, service_meta, package_name, workflow_items);
