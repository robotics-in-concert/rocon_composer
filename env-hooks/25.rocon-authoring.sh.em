...
: ${ROCON_SERVICE_COMPOSER_BLOCKLY_MONGO_URL:=mongodb://localhost:27017/cento_authoring}
: ${ROCON_SERVICE_COMPOSER_BLOCKLY_SERVER_PORT:=9999}
: ${ROCON_SERVICE_COMPOSER_BLOCKLY_ROSBRIDGE_URL:=ws://localhost:9090}
: ${ROCON_SERVICE_COMPOSER_BLOCKLY_DELAY_AFTER_TOPICS:=2000}
: ${ROCON_SERVICE_COMPOSER_BLOCKLY_PUBLISH_DELAY:=100}


#Exports
export ROCON_SERVICE_COMPOSER_BLOCKLY_MONGO_URL
export ROCON_SERVICE_COMPOSER_BLOCKLY_SERVER_PORT
export ROCON_SERVICE_COMPOSER_BLOCKLY_ROSBRIDGE_URL
export ROCON_SERVICE_COMPOSER_BLOCKLY_DELAY_AFTER_TOPICS
export ROCON_SERVICE_COMPOSER_BLOCKLY_PUBLISH_DELAY
